...
# Detect local network IP for LAN access (phones, tablets, rework stations)
...
echo "=========================================================="
echo " 🚀 Starting LuminoAI Application Server (LAN Enabled)..."
echo " 💻 Local Station:    ${URL}"
echo " 📲 Rework Mobile:    http://${LOCAL_IP}:${PORT}/rework"
echo "=========================================================="

# Automatically free port 8005 if occupied by an orphaned instance
EXISTING_PID=$(lsof -ti :${PORT} 2>/dev/null || true)
if [ -n "$EXISTING_PID" ]; then
    echo " [INFO] Port ${PORT} is currently in use (PID: ${EXISTING_PID}). Freeing port..."
